// Google Apps Script for Doctor's Logbook - Working CORS Solution
...
function doPost(e) {
  try {
    ...
    if (!e.postData.contents || e.postData.contents === '') {
    ...
    switch (action) {
      case 'addPatient':
        result = addPatient(data.data);
        break;
      case 'getPatients':
        result = getPatients();
        break;
      case 'getPatient':
        result = getPatient(data.id);
        break;
      case 'updatePatient':
        result = updatePatient(data.id, data.data);
        break;
      case 'deletePatient':
        result = deletePatient(data.id);
        break;
      default:
